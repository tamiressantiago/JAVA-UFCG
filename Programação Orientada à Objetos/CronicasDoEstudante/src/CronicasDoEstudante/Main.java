...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(sistema.contemCronicaNoLivreto("Minha semana do fera 2022.2",
		0));
		System.out.println(sistema.contemCronicaNoLivreto("Meu primeiro simulado de P2",
		0));
		}
	}
